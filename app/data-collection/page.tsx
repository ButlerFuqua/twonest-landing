...
export const metadata: Metadata = {
  title: "Data Collection Policy | TwoNest",
  description: "Data collection and usage policy for the TwoNest co-parenting platform.",
}

export default async function DataCollectionPage() {
  const content = await getMarkdownContent("data-collection.md")
